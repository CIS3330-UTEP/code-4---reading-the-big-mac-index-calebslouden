...
def get_the_cheapest_big_mac_price_by_year(year):
    ...
    rounded_min_value = f"{min_value['name']}({min_value['iso_a3'].upper()}): ${round(min_value['dollar_price'],2)}"
...
def get_the_most_expensive_big_mac_price_by_year(year):
    ...
    rounded_max_value = f"{max_value['name']}({max_value['iso_a3'].upper()}): ${round(max_value['dollar_price'],2)}"
